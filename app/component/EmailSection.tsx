    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link
            href="https://www.github.com/maxi-p"
            target="_blank"
            style={{ marginRight: -6 }}
          >
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/maxi-p/" target="_blank">
            <Image src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
          <Link href="mailto:max.petrushin16@gmail.com" target="_blank">
            <Image src={GmailIcon} alt="Gmail Icon" />
          </Link>
          <Link
            href="https://www.facebook.com/maksim.petrushin.39/"
            target="_blank"
          >
            <Image src={FacebookIcon} alt="Facebook Icon" />
          </Link>
          <Link
            href="https://www.instagram.com/maksim_petrushin16/"
            target="_blank"
          >
